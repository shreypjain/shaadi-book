...
function SuggestionRow({ suggestion, onReviewed }: SuggestionRowProps) {
  ...
  return (
    <div className="rounded-lg border border-[rgba(184,134,11,0.12)] bg-white p-4 space-y-3">
      {/* Header */}
        ...
        <div className="space-y-2 pt-1">
          ...
          {!showNotes ? (
            <button
              ...
              className="text-xs text-warmGray hover:text-warmGray underline min-h-0 min-w-0 h-auto"
            >
              + Add a note (optional)
            </button>
          ) : (
            <div>
              <textarea
                ...
                className="w-full rounded border border-[rgba(184,134,11,0.12)] px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-gray-300 resize-none"
              />
            </div>
          )}
    ...
    <div className="max-w-3xl space-y-6">
      ...
      {isLoading && (
        <div className="space-y-3">
          {[1, 2, 3].map((n) => (
            <div key={n} className="rounded-lg border border-[rgba(184,134,11,0.12)] bg-white p-4 animate-pulse">
