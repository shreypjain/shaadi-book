  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <div className="bg-white border-b border-[#e8e4df] px-4 pt-12 pb-2">
        <h1 className="text-2xl font-bold text-[#1a1a2e] tracking-tight">Leaderboard</h1>
      ...
      <div className="max-w-lg mx-auto px-4 pt-4 space-y-4">
        ...
        <div className="bg-white rounded-xl shadow-card border border-[#e8e4df] p-4">
          {entriesLoading ? (
            ...
            <div className="text-center py-10">
              ...
              <p className="font-semibold text-[#1a1a2e]">Leaderboard is empty</p>
        ...
        {/* Footer note */}
        <p className="text-xs text-[#8a8a9a] text-center pb-2">
