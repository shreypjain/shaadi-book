 ...
 *   3. resolveMarket → winning positions paid full $1.00 per share (no charity at resolution)
...
// ---------------------------------------------------------------------------
// Test 3: resolveMarket — winners paid full $1.00 per share (charity at withdrawal)
// ---------------------------------------------------------------------------
...
describe("resolveMarket", () => {
  ...
  it("Guest A receives full gross payout ($1.00 per share, no charity deduction)", async () => {
    // Guest A has 5 shares → payout = $5.00 (full $1.00/share; charity withheld at withdrawal)
  ...
  it("no CHARITY_FEE transaction created at resolution (charity deferred to withdrawal)", async () => {
